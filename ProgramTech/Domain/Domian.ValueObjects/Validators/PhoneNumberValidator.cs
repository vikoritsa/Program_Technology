...
{
    /// <summary>
    /// The PhoneNumber's max length
    /// </summary>
    public static int MAX_LENGTH => 11;

    /// <summary>
    /// The PhoneNumber's min length
    /// </summary>
    public static int MIN_LENGTH => 10;

    /// <summary>
    /// Verifies the string to make sure it is not null, empty or doesn't consists only white-space characters and contains digits.
    /// </summary>
    ...
    public void Validate(string value)
    {
        ...
        if (!value.All(char.IsDigit))
            throw new ArgumentNotDigitsException(nameof(value), value);
    }
}